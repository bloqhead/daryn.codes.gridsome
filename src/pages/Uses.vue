  ...
  <div class="page-content">
    ...
    <div class="intro">
      <p>
        ...
        <a
          ...
          target="_blank"
        >Wes Bos</a>, I've created a page that outlines the every day things I use. I always love seeing what others use and added this for anyone that might be interested.
      </p>
    </div>
    ...
    <ul class="list">
      ...
      <li>
        ...
        >STM Prime Backpack</a> in steel gray
      </li>
      <li>
        <a
          href="https://www.amazon.com/gp/product/B01872MCIA/"
          rel="noindex nofollow"
        >68-key Qisan Magicforce gaming keyboard</a> w/ MX Blue dampers
      </li>
      <li>
